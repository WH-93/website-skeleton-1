  ...
  const services = [
    {
      ...
      desc: 'Audit, Accounts, Advisory & Practice Management — from newly qualified to partner level.',
      roles: ['Audit Senior/Manager', 'Accounts Manager', 'Client Director', 'Practice Manager'],
    },
    {
      emoji: '🔍',
      title: 'Tax Recruitment',
      desc: 'Corporate Tax, Personal Tax, VAT, Employment Tax & In-House Tax specialists.',
      roles: ['Corporate Tax Director', 'Personal Tax Senior', 'VAT Manager', 'Employment Tax Lead', 'In-House Tax Manager'],
    },
    {
      emoji: '🎯',
      title: 'Search & Selection',
      desc: 'Specialist, senior and hard-to-fill appointments requiring discretion and market insight.',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {services.map(s => (
            <div key={s.title} className="bg-navy-800 border border-gold/10 rounded-card p-6 sm:p-8">
              <div className="icon-circle-sm text-gold mb-4">{s.emoji}</div>
